...
export const CHAR_DATA: CharConfig[] = [
  // === MyGO!!!!! ===
  {
    ...
    keys: ["灯","高松灯","小灯","Tomori","tomorin","灯皇","高松","ともり","たかまつ","tomori","企鹅","灵感菇","咕咕嘎嘎","gugugaga","guga","takamatsu","Takamatsu","Tomori"],
  ...
  },
  {
    ...
    keys: ["素世","长崎素世","爽世","长崎爽世","そよ","soyo","soyorin","长崎","一之濑","一之濑素世","一之濑爽世","ながさき","寡妇","人妻"],
    baseStats: { Obsession: 60 }
  },
  {
    id: "taki", name: "椎名 立希", sub: "MyGO!!!!!", hex: "#7777AA", avatar: "🐼",
    keys: ["立希","椎名立希","椎名","利息","追命利息","たき","しいな","しいなたき","shiina","Shiina","taki","Taki","Rikki","rikki","りっきー","狸希"],
    baseStats: { Obsession: 8 }
  },
  {
    id: "rana", name: "要 乐奈", sub: "MyGO!!!!!", hex: "#77DD77", avatar: "🐱",
    keys: ["要乐奈","乐奈","かなめ","らな","かなめ　らな","Kaname","rana","Rana","kaname","Kaname rana","抹茶芭菲","小猫","猫猫","流浪猫"],
  ...
  // === Ave Mujica ===
  {
    ...
    keys: ["祥子","小祥","丰川祥子","丰川","saki","さき","とがわ","さきこ","sakiko","さきちゃん","Oblivionis","Ob一串字母小姐","祥"],
    baseStats: { Obsession: 20 }
  },
  {
    id: "mutsu", name: "若叶 睦", sub: "Ave Mujica", hex: "#779977", avatar: "🥒",
    keys: ["睦", "墨缇丝", "Mortis", "mortis", "若叶睦", "若叶", "森美奈美的女儿", "森美奈美", "若叶隆文", "Mutsumi", "睦子米", "小睦", "剑姬", "睦头人", "むつみ", "わかば", "モーティス"],
    baseStats: { Obsession: 15 }
  },
  {
    id: "uika", name: "三角 初华", sub: "Ave Mujica", hex: "#BB9955", avatar: "✨",
    keys: ["三角初华","初华","三角","初音","丰川初音","Doloris","doloris","uika","misumi","sumimi","ういか","みすみ","ういかちゃん","Misumi","はつね","初音未来","miku"],
    baseStats: { Obsession: 70 }
  },
  {
    id: "nyamu", name: "祐天寺 若麦", sub: "Ave Mujica", hex: "#AA4477", avatar: "💄",
    keys: ["祐天寺若麦", "若麦", "喵姆", "喵姆亲", "喵梦", "键帽", "大喵", "大喵老师", "ゆうてんじ", "にゃむ", "にゃむち", "ゆうてんじ にゃむ", "Amoris", "amoris", "aminos", "nyumu", "Nyamu", "Aminos", "祐天寺"],
    baseStats: { Obsession: 3 }
  },
  {
    id: "umiri", name: "八幡 海铃", sub: "Ave Mujica", hex: "#335566", avatar: "🎧",
    keys: ["八幡海铃","八幡","Timoris","timoris","贝斯雇佣兵","芝麻信用","信用姐","やはた","うみり","やはた　うみり","Yahata","yahata","Umiri","umiri","Yahata umiri","无米铃","乌米铃","海铃","海玲"],
  ...
  // === Sumimi ===
  {
    ...
    keys: ["纯田真奈","纯田","真奈","甜甜圈","甜甜圈女士","sumimi","すみた","まな","すみた　まな","sumita","Sumita","Mana","mana","Sumita mana"],
    baseStats: { Obsession: 1 }
  }
];